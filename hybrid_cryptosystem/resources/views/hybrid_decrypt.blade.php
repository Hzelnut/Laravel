    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <h2 class="text-xl font-bold mb-4">Hybrid Decryption</h2>

                <form method="POST" action="{{ route('decrypt.hybrid') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded">Decrypt and Download</button>
                </form>
            </div>
        </div>
    </div>
